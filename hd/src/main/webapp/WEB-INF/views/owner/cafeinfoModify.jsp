...
<main class="layoutCenter">
	...
	<input type="hidden" id="CAFE_IDX" name="CAFE_IDX" value="${map.CAFE_IDX }">
			<table class="board_view">
				...
				<tbody>
					...
					<tr>
						...
						<td><select name="CAFE_OFFDAY" id="CAFE_OFFDAY">
					...
					<tr>
						...
						<td class="view_text"><textarea rows="5" style="width: 80%; height: auto;" title="내용" id="CAFE_CONTENTS" name="CAFE_CONTENTS">${map.CAFE_CONTENTS }</textarea></td>
					</tr>
					<tr>
						<th scope="row">이용/취소안내</th>
						<td class="view_text"><textarea rows="5" style="width: 80%; height: auto;" title="내용" id="CAFE_NOTICE" name="CAFE_NOTICE">${map.CAFE_NOTICE }</textarea></td>
					</tr>
				</tbody>
			</table>
			<div id="fileDiv">
				<p>
					<input type="file" id="file" name="file_0"> <a href="#this" class="btn" name="delete" >삭제</a>
				</p>
			</div>
