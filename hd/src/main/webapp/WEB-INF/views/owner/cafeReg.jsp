			...
			<tbody>
				...
				<tr>
					...
					<span>
					 ...
					 <input type="text" id="bankaccount" name="bankaccount" style="width:325px;" placeholder="-없이 입력해주세요."></input>
					 </span>
					 </td>
				</tr>
				<tr>
					...
					<td colspan="2" class="view_text">
						<textarea rows="20" cols="48" title="내용" id="CAFE_CONTENTS" name="CAFE_CONTENTS"></textarea>
					</td>
				</tr>
				<tr>
					<th scope="row">이용/취소<br>&nbsp;&nbsp;안내</th>
					<td colspan="2" class="view_text">
						<textarea rows="15" cols="48" title="내용" id="CAFE_NOTICE" name="CAFE_NOTICE"></textarea>
					</td>
				</tr>
			</tbody>
		</table>
